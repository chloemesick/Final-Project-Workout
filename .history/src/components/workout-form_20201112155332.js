...
if (initialState.dateAdded === undefined) initialState.dateAdded = "";
if (initialState.focus === undefined) initialState.focus = 3;
if (initialState.moves === undefined) initialState.moves = 2020;
if (initialState.releaseYear === undefined) initialState.reps = 2020;
if (initialState.releaseYear === undefined) initialState. = 2020;
if (initialState.releaseYear === undefined) initialState.moves = 2020;
