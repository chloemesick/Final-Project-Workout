...
function WorkoutForm(props) {
  ...
  if (initialState.dayOfWeek === undefined) initialState.dayOfWeek = "monday";
  ...
  const onWorkoutSumbit = async (event) => {
    ...
    onSubmit(dateAdded, focus, moves, reps, timing, notes, rating, dayOfWeek);
  };
  ...
  return (
    <form className="workout-form" onSubmit={onWorkoutSumbit}>
      ...
      <fieldset className="workout-form__controls" disabled={isSaving}>
        ...
        />
        <label className="workout-form__label">Day </label>
