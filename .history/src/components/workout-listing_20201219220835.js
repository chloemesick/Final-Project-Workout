...
function WorkoutListing(props) {
  ...
  const [workouts, isLoading, errorMessage] = useAllWorkouts(userId, filterDayOfWeek);
  ...
  return (
    <div className="workout-container">
      ...
      <select className="dayOfWeek-button" value={filterDayOfWeek} onChange={onFilterSubmit}>
        ...
        <option value="Wednesday">Show only Wednesday</option>
        <option value="Thursday">Show only Thursday</option>
        <option value="Friday">Show only Friday</option>
        <option value="Saturday">Show only Saturday</option>
      </select>
