...
async function addWorkout({ dateAdded, focus, moves, notes, reps, timing, rating}) {
  try {
    const data = { dateAdded, focus, moves, notes, reps, timing, <div className="workout__notes">{notes}</div>rating };
